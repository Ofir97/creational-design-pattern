...
public abstract class EnemyShip {
    ...
    public void followHeroShip(){
        ...
        System.out.println(getName() + " is following the hero at " + engine.speed() );
    ...
    public void enemyShipShoots(){
        ...
        System.out.println(getName() + " attacks and does " + weapon.shoot());
    ...
    public String toString(){
        ...
        String infoOnShip = "The " + name + " has a top speed of " + engine.speed() +
                " and an attack power of " + weapon.shoot();
